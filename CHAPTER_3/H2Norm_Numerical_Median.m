...
for j = 5:10:45
   for jj = 1:1
       ...
       %% Calculate H2 norm
       H2n2_Median(counter) = (p1(1) * gamma)/(2*pkhat(1)*cd(1));
       t(counter,jj) = toc;
   end
